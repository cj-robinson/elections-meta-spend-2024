...
meta_ads_expanded %>% 
  ...
  labs(title = "Courier's Pennsylvania outlet targeted ads toward women more than men", 
       subtitle = "The Keystone 2024 Meta ad count by women targeted as a proportion of total audience") +
  xlab("Percentage of Women Targeting") +
  theme_minimal() +
  ...
  theme(axis.title.y=element_blank(),
        ...
        plot.title = element_text(size = 20),
        plot.subtitle = element_text(size = 16)) + 
  annotate("text", x = 0.34, y = 35, label = "Most ads targeted more women", size = 6, hjust = 1) +
  annotate("curve", x = 0.35, y = 35, xend = 0.55, yend = 33, curvature = - 0.25, arrow = arrow(length = unit(0.5, "cm"))) +
...
meta_ads_expanded %>% 
  ...
  # geom_vline(aes(xintercept = .5), linetype="dotted") +
  labs(title = "Courier's Pennsylvania outlet targeted ads more toward women", 
